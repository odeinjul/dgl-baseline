...
from train_dist import DistGAT, compute_acc        
...
def run(args, device, data, group=None):
    ...
    iter_tput = []
    epoch = 0
    log_path = f'./result/{args.graph_name}_gat.log'
    res_path = f'./result/{args.graph_name}_gat.txt'
    epoch_list = []
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--heads", type=int, default=8, help="head num of GAT"
    )
