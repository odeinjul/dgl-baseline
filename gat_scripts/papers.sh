python3 ~/workspace/dgl-baseline/tools/launch.py --workspace ~/workspace/dgl-baseline/src \
    ...
    "/home/ubuntu/anaconda3/envs/dglbase/bin/python3 ~/workspace/dgl-baseline/src/train_dist_transductive_gat.py --graph_name ogb-paper100M \
    --ip_config ip_config_4p.txt --batch_size 1000 --num_gpus 8 --eval_every 5 --num_epochs 20 \
    --fan_out "5,10,15" --lr 0.003 --sparse_lr 0.01 --feat_dropout 0.1 --attn_dropout 0.1 \
