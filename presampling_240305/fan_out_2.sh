python3 ~/workspace/dgl-baseline/tools/launch.py --workspace ~/workspace/dgl-baseline/src \
    ...
    --ip_config ip_config_4p.txt --batch_size 1000 --num_gpus 8 --eval_every 1 --num_epochs 1 \
    --fan_out "25,10" --lr 0.003 --sparse_lr 0.01 --dropout 0.5 \
...
python3 ~/workspace/dgl-baseline/tools/launch.py --workspace ~/workspace/dgl-baseline/src \
    ...
    --ip_config ip_config_4p.txt   \
    "/home/ubuntu/anaconda3/envs/dglbase/bin/python3 ~/workspace/dgl-baseline/src/train_dist_transductive_presampling.py --graph_name ogb-paper100M \
    --ip_config ip_config_4p.txt --batch_size 1000 --num_gpus 8 --eval_every 5 --num_epochs 1 \
    --fan_out "25,10" --lr 0.003 --sparse_lr 0.01 --dropout 0.5 \
