/home/ubuntu/anaconda3/envs/dglbase/bin/python3 ~/workspace/dgl-baseline/src/train_dist_transductive_hotness_degree_single_machine.py --graph_name ogb-paper100M    \
